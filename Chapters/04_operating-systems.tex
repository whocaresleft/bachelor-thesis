...
La problematica principale deriva dal fatto che la gestione degli errori è non obbligatoria, sta alla discrezione del programmatore controllare la validità dei \textit{file descriptor}
...
di confronto rigorosa, che andrebbe oltre gli obiettivi di questa trattazione. \hfill
\vspace{10pt}\\
...
Per ciascun linguaggio è stata selezionata l'esecuzione migliore e quella peggiore esecuzione in termini di \textbf{cpu secs}. Sono state considerate solo 
...
L'algoritmo presenta un carico elaborazione minimo: rappresenta un esempio di algoritmo principalmente \textit{I/O-bound}, in quanto la maggior parte del tempo di esecuzione è trascorso in scrittura sullo standard output.
