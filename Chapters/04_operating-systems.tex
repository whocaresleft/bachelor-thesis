...
\textit{Double free} è un'errore di gestione della memoria che si verifica la stessa area di memoria viene deallocata
...
% Dangling pointers
\subsubsection{Puntatore penzolante (\textit{dangling pointer})}
