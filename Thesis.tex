...
%--------------------------------------------------------------
\newcommand{\myItalianTitle}{Analisi del linguaggio Rust e della sua adozione nei sistemi operativi\xspace}
\newcommand{\myEnglishTitle}{Analysis of Rust and its adoption in operating systems\xspace}
